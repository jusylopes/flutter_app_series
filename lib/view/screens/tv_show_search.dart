...
import 'package:flutter_app_series/view/widgets/tv_show_grid.dart';
...
class _TvShowSearchScreenState extends State<TvShowSearchScreen> {
  ...
  late Future<List<TvShowModel>>? searchResults;

  bool onSubmit = false;
  void submit() {
    if (_formKey.currentState!.validate()) {
      final tvShowModel = context.read<TvShowViewModel>();
      setState(() {
        onSubmit = true;
